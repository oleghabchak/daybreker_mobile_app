-- Migration: Add user account deletion function
-- This function allows users to hard delete their own accounts
...
-- Note: This policy might not work directly on auth.users table
-- The security is enforced by the function itself checking auth.uid()
