revoke delete on table "public"."health_sync_logs" from "anon";

revoke insert on table "public"."health_sync_logs" from "anon";

revoke references on table "public"."health_sync_logs" from "anon";

revoke select on table "public"."health_sync_logs" from "anon";

revoke trigger on table "public"."health_sync_logs" from "anon";

revoke truncate on table "public"."health_sync_logs" from "anon";

revoke update on table "public"."health_sync_logs" from "anon";

revoke delete on table "public"."health_sync_logs" from "authenticated";

revoke insert on table "public"."health_sync_logs" from "authenticated";

revoke references on table "public"."health_sync_logs" from "authenticated";

revoke select on table "public"."health_sync_logs" from "authenticated";

revoke trigger on table "public"."health_sync_logs" from "authenticated";

revoke truncate on table "public"."health_sync_logs" from "authenticated";

revoke update on table "public"."health_sync_logs" from "authenticated";

revoke delete on table "public"."health_sync_logs" from "service_role";

revoke insert on table "public"."health_sync_logs" from "service_role";

revoke references on table "public"."health_sync_logs" from "service_role";

revoke select on table "public"."health_sync_logs" from "service_role";

revoke trigger on table "public"."health_sync_logs" from "service_role";

revoke truncate on table "public"."health_sync_logs" from "service_role";

revoke update on table "public"."health_sync_logs" from "service_role";

create table "public"."device_connections" (
    "id" uuid not null default gen_random_uuid(),
    "user_id" uuid not null,
    "provider" text not null,
    "terra_reference_id" text,
...
CREATE UNIQUE INDEX device_connections_pkey ON public.device_connections USING btree (id);

alter table "public"."device_connections" add constraint "device_connections_pkey" PRIMARY KEY using index "device_connections_pkey";
